...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        invokeMethod(page, request, view, response, pageClass, findMethod(pageClass, "before"));
        Method actionMethod = findMethod(pageClass, route.getAction());
        boolean isNotRender = invokeMethod(page, request, view, response, pageClass, actionMethod);
        invokeMethod(page, request, view, response, pageClass, findMethod(pageClass, "after"));
        ...
        try {
            ...
            throw new ServletException("Can't render template [pageClass=" + pageClass + ", method].", e);
        }
    }

    private boolean invokeMethod(Object page, HttpServletRequest request, Map<String, Object> view, HttpServletResponse response, Class<?> pageClass, Method method) throws ServletException, IOException {
        try {
    ...
    private Method findMethod(Class<?> pageClass, String methodName) throws NotFoundException {
        Method method = null;
